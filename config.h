...
static Key keys[] = {
    ...
    { MODKEY,			XK_c,		spawn,		SHCMD("autorandr docked") },
    { MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("autorandr undocked") },
	...
	{ MODKEY,			XK_F7,		spawn,		SHCMD("gbacklight") },
	...
	{ 0, XF86XK_WWW,		spawn,		SHCMD("librewolf") },
